  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="viewDoctor.jsp">VIEW DOCTOR</a>
        </li>
        <li class="nav-item">
        ...
        <div class="nav-item dropdown text-decoration-none">
          <button class="btn btn-light dropdown-toggle text-decoration-none" href="#" id="navbarDropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            Admin
          </button>
